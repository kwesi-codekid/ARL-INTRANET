...
const navItems = [
  ...
  { label: "Apps", to: "https://apps.adamusgh.com/", icon: AppWindow, external: true },
];
        ...
        {navItems.map((item) => (
          item.external ? (
            <a
              ...
              className="flex flex-1 flex-col items-center gap-1 py-2 transition-colors text-gray-500 hover:text-gray-700"
            >
              <item.icon size={22} />
